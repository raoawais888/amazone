...
router.get("/edit-category",checkLogin, isAdmin, categoryController.editCategory);
router.post("/edit-category", upload.single("categoryImg"), categoryController.updateCategory);
router.get("/delete-category",checkLogin, isAdmin, categoryController.deleteCategory);
//Products Routes
...
router.get("/edit-product",checkLogin, isAdmin, productController.editProduct);
router.post("/edit-product", upload.single("productImg"),productController.updateProduct);
router.get("/delete-product",checkLogin, isAdmin, productController.deleteProduct);
